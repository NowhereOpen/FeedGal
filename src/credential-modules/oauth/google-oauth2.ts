 ...
 */
export default class Google extends OAuth2BaseClass {
  ...
  async getUserInfo(token_data:any) {
    ...
    return await axios.get("https://openidconnect.googleapis.com/v1/userinfo", { params: { access_token } })
  }
   ...
   */
  revokeToken(token_response:any) {
