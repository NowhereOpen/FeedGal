...
} from "~/src/server/method-collection"
...
import {
  PaginationDirection,
  EntriesResult
} from "~/src/server/method-collection/common/services/base/types"
import {
...
export async function getEntriesPaginationData(
  ...
  let output:EntriesResult = { entries: [], service_response: null, pagination_data }
